...
using OnlineTrainingTracker.Data;
using OnlineTrainingTracker.Models;

namespace OnlineTrainingTracker.Controllers
{
    public class EmployeeDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstMidName,EnrollmentStartDate,EnrollmentEndDate,CourseStatus")] EmployeeDetails employeeDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstMidName,EnrollmentStartDate,EnrollmentEndDate,CourseStatus")] EmployeeDetails employeeDetails)
        {
